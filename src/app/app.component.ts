import { Component, ViewChild, OnInit, OnDestroy, ElementRef, ChangeDetectionStrategy, ChangeDetectorRef, AfterViewInit } from '@angular/core';
...
export class AppComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  loadEnd = false;
  constructor(private dref: ChangeDetectorRef) {
  }
  ngAfterViewInit() {
    setTimeout(() => {
